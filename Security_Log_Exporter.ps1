...
$API_KEY      = "c4d2f35bef334a9abbac944db0c7ce45"
...
<#
    This function creates sample log files that will be used to train the
    Extract feature in Log Analytics workspace. If you don't have enough log files to
    "train" it, it will fail to extract certain fields.
#>
